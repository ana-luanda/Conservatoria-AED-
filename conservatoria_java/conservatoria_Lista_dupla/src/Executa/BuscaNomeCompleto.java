...
public class BuscaNomeCompleto extends JInternalFrame{
	...
	public BuscaNomeCompleto(ListaLigada lista) {
//		setBounds(100, 100, 333, 117);
		setTitle("BUSCA PELO NOME COMPLETO");
		setClosable(true);
		setIconifiable(true);
		setResizable(false);
		...
		JLabel label = new JLabel("BUSCA PELO NOME COMPLETO");
		...
		table.setToolTipText("BUSCA PELO NOME COMPLETO");
